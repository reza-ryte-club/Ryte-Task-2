...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_testingStoryboardCell) {
         ...
         **/
        static NSString * reuseIdentifier = @"ThirdTableCell";
...
//This is important
#if TEST_USE_MG_DELEGATE
-(NSArray*) swipeTableCell:(ThirdTableCell*) cell swipeButtonsForDirection:(MGSwipeDirection)direction
             swipeSettings:(MGSwipeSettings*) swipeSettings expansionSettings:(MGSwipeExpansionSettings*) expansionSettings;
{
    ThirdTableCell * data = [tests objectAtIndex:[_tableView indexPathForCell:cell].row];
...
-(BOOL) swipeTableCell:(ThirdTableCell*) cell tappedButtonAtIndex:(NSInteger) index direction:(MGSwipeDirection)direction fromExpansion:(BOOL) fromExpansion
{
